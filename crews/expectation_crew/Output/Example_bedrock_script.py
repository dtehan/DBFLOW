...
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="driveway"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="recroom"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="fullbase"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="gashw"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="airco"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="garagepl"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="prefarea"))
data_context.suites.get(table_name).add_expectation(gx.expectations.ExpectColumnValuesToNotBeNull(column="homestyle"))
